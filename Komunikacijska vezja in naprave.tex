...
\section{Digitalna komunikacija}
    ...
    \subsection{Error correction}
        ...
        \subsubsection{Cyclic redundancy check}
            ...
            operaciji in zgleda kot da sta se polinoma seštela}
            \begin{equation}
                \begin{split}
                    s(x) = & m(x) - r(x)\\
                    = & (x^{38} + x^{35} + x^{34} + x^{33} + x^{32} +
            ...
            deljenju pa mora biti sedaj 0. Če temu ni tako smo lahko prepričani,
            da smo sporočilo prejeli narobe. Žal ne moremo ugotoviti kje se je 
            napaka zgodila
